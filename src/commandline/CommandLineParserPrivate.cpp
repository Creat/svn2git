...
CommandLineParserPrivate::CommandLineParserPrivate(int argc, char** argv) : 
    argumentCount(argc), 
...
void CommandLineParserPrivate::addDefinitions(const CommandLineOption* options)
{
...
void CommandLineParserPrivate::parse()
{
    if (dirty == false)
    {
        return;
